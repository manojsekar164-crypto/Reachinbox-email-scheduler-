    ...
    <div className="min-h-screen bg-slate-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-2 text-center text-sm text-slate-400">
          Production-grade email campaign & scheduling platform
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-xs text-slate-400 mt-1">
                Access your scheduled email queues, delivery logs & integrations.
              </p>
            </div>
            ...
            <button
              onClick={login}
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-slate-600 bg-white hover:bg-slate-50 text-slate-900 font-semibold text-sm shadow-md transition-all hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50"
            >
              {/* Google G Logo SVG */}
            ...
            <div className="pt-4 border-t border-slate-700/60 space-y-3">
              <div className="flex items-center gap-3 text-xs text-slate-300">
                ...
                <span>Exact-Time BullMQ Delayed Scheduling</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-slate-300">
                <div className="p-1 rounded-lg bg-sky-500/10 text-sky-400">
                  <ShieldCheck className="w-4 h-4" />
                </div>
                <span>Redis Rate Limiting & Inter-Send Spacing</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-slate-300">
                <div className="p-1 rounded-lg bg-purple-500/10 text-purple-400">
                  <Sparkles className="w-4 h-4" />
                </div>
                <span>Elasticsearch Full-Text Query Indexing</span>
              </div>
            </div>
          </div>
        </div>
